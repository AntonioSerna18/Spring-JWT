package com.tortastack.springboot.app.view.xlsx;
...
import com.tortastack.springboot.app.models.entity.ItemFactura;
...
public class FacturaXlsxView extends AbstractXlsxView{
	...
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
		...
		Sheet sheet = workbook.createSheet(factura.getDescripcion());
		...
		cell = row.createCell(0);
		cell.setCellValue("Correo electrónico: " + factura.getCliente().getEmail());
